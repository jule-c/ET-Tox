...
class MoleculeNetSingle(Dataset):
    ...
    def processed_file_names(self):
        return [
            f"{self.dataset}.idx_{self.num_conformers}_{self.data_version}.mmap",
            f"{self.dataset}.z_{self.num_conformers}_{self.data_version}.mmap",
            f"{self.dataset}.pos_{self.num_conformers}_{self.data_version}.mmap",
            f"{self.dataset}.y_{self.num_conformers}_{self.data_version}.mmap",
            f"{self.dataset}.smiles_{self.num_conformers}_{self.data_version}.mmap",
            f"{self.dataset}.Q_{self.num_conformers}_{self.data_version}.mmap",
            f"{self.dataset}.tox_labels_{self.num_conformers}_{self.data_version}.mmap",
        ]
    ...
    def sample_iter(self):
        ...
        unique_chars = list(set([char for smiles in set(smiles_strings) for char in smiles]))
    ...
    def get(self, idx):
        ...
        return Data(z=z, pos=pos, y=y, smiles=smiles, Q=Q, tox_labels=tox_labels)
