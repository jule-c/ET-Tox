...
from torchmdnet.models.energy_correction.functional import softplus_inverse, switch_function
...
class D4DispersionEnergy(nn.Module):
    ...
    def forward(
        ...
        covcn = rij.new_zeros(N).index_add_(0, idx_i, tmp.float())
        ...
        edisp = rij.new_zeros(N).index_add_(0, idx_i, pairwise.float())
